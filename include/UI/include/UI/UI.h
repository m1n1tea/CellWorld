...
namespace cellworld {
    ...
    *\brief Класс графического интерфейса.
    ...
    Сцены самостоятельны внутри себя(за исключением записи и чтения данных, которые доступны для всех сцен), должны предоставлять возможность сменить сцену.
    */
    class UI {
    public:
    ...
    private:
        ...
        /*!
        \brief Функция для сцены стартового экрана
* 
*       Возможности:
