...
namespace cellworld {
    ...
    *\brief Класс графического интерфейса.
    ...
    Сцены почти самостоятельны внутри себя, должны предствлять возмность сменить сцену.
    */
    class UI {
    public:
...
*       Возможности:
        ...
        */
        ...
        Возможности:
            ...
            - задать имя мир и сохранить мир с ним;
            -посмотреть fps, количество сделанных шагов симуляции;
