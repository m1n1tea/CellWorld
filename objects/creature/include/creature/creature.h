...
public:
    ...
    */
    ...
    /*!
    \brief Цвет энергии. Цвет мёртового существа зависит от его текущей энергии.
    */
...
///@}
    ...
    */
    ...
    /*!
    \brief Нормализация входных данных. Переводит в диапозон [0;1] путём быстрого, но неточного деления на само себя.
    */
    void reverseInput();
...
class Field{
    ...
    */
    ...
    //на самом деле им не надо быть друзьми, но для документации красивоы
